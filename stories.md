...
* restaurant_search{"budgetmin": "300", "budgetmax": "700"}
    ...
    - utter_ask_emailid
* restaurant_search{"emailid": "abcd@gmail.com"}
    - slot{"emailid": "abcd@gmail.com"}
    - action_send_email
    - export
...
* send_mail
    - utter_ask_emailid
* send_mail{"emailid": "wxyz@gmail.com"}
    - slot{"emailid": "wxyz@gmail.com"}
    - action_send_email
...
* restaurant_search{"budgetmin": "700"}
    ...
    - slot{"restaurant_exist": true}
    - utter_ask_email
* send_mail{"emailid": "efgh@gmail.com"}
    - slot{"emailid": "efgh@gmail.com"}
    - action_send_email
    - export
...
* affirm
    - utter_ask_emailid
* send_mail{"emailid": "stuv@gmail.com"}
    - slot{"emailid": "stuv@gmail.com"}
    - action_send_email
* goodbye
    - utter_goodbye
    - export
